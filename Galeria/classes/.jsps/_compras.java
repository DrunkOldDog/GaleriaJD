  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:22^1*/            {
              ...
              __jsp_taghandler_2.setKey("fecha.promp");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:23^1*/            {
              org.apache.struts.taglib.html.TextTag __jsp_taghandler_3=(org.apache.struts.taglib.html.TextTag)OracleJspRuntime.getTagHandler(pageContext,org.apache.struts.taglib.html.TextTag.class,"org.apache.struts.taglib.html.TextTag property readonly value");
              __jsp_taghandler_3.setParent(__jsp_taghandler_1);
              __jsp_taghandler_3.setProperty("fecha");
              __jsp_taghandler_3.setReadonly(true);
              __jsp_taghandler_3.setValue( OracleJspRuntime.toStr( dateFormat.format(cal.getTime())));
            ...
            /*@lineinfo:translated-code*//*@lineinfo:24^1*/            {
              ...
              __jsp_taghandler_4.setKey("obra.promp");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:25^1*/            {
              ...
              __jsp_taghandler_5.setProperty("obras");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:26^11*/                  {
                    ...
                    __jsp_taghandler_6.setLabelProperty("descr");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:26^86*/                } while (__jsp_taghandler_5.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
                __ojsp_s_out = (com.evermind.server.http.JspCommonExtraWriter) out;
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:27^15*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
      ...
      /*@lineinfo:user-code*//*@lineinfo:30^1*/      out.print( new java.util.Date() );
      /*@lineinfo:generated-code*/
