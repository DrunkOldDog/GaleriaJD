        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:18^3*/            {
              ...
              __jsp_taghandler_4.setValue("Exposiciones");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:19^3*/            {
              ...
              __jsp_taghandler_5.setValue("Obras");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:20^3*/            {
              ...
              __jsp_taghandler_6.setValue("Compras");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:21^3*/            {
              ...
              __jsp_taghandler_7.setValue("Ventas");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:22^3*/            {
              ...
              __jsp_taghandler_8.setValue("Exposiciones Pasadas");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:22^95*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
