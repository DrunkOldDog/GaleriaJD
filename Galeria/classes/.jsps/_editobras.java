...
public class _editobras extends oracle.jsp.runtime.HttpJsp {
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:15^3*/      {
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:18^35*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
