    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:30^3*/      {
        ...
        if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
        {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:41^64*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
      ...
      /*@lineinfo:user-code*//*@lineinfo:47^1*/      out.print( new java.util.Date() );
      /*@lineinfo:generated-code*/
